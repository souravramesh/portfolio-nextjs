...
const phrases = [
  "I build reliable mobile applications.",
  "I focus on performance and detail.",
  "I deliver smooth cross-platform experiences.",
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed text-balance animate-fade-in-delay-2">
          I develop, and deploy cross-platform apps — from concept to release —
          with clean architecture and pixel-perfect UI.
        </p>

        <div className="flex flex-col items-center gap-3 mb-12 animate-fade-in-delay-3">
          <p className="text-base md:text-lg font-medium">Sourav Ramesh</p>
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1.5">
              <MapPin className="w-4 h-4" />
              <span>Koratty, Thrissur</span>
            </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-delay-4">
          ...
          <a
            href="/Sourav-Ramesh-Resume.pdf"
            download="Sourav-Ramesh-Resume.pdf"
            className="px-8 py-4 border border-border rounded-lg hover:bg-muted transition-colors font-medium flex items-center gap-2"
          >
            Download CV
